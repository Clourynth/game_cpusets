...
ui_print ""
ui_print "  Note: "
ui_print "  You can add app or games to the list after reboot by  "
ui_print "  editing the game_list.txt for games (Performance) "
ui_print "  and app_list.txt file for daily apps (Power Saving) "
